'''
Current clamp demo using Allen Brain's model 471081668.
...
from neuron471081668 import Neuron471081668
...
def demo(iapp):
    ...
    h.celsius = 34.0
    cell = Neuron471081668(name='neuron')
    ...
    vbox.intercept(0)
    vbox.map('Allen Institute model 471081668; v includes junction potential', 10, 10, 600, 400)

    # procedure for doing and plotting each simulation
    def do_current_clamp_experiment(amp, color):   
        ic.amp = amp / 1000.
        
        h.finitialize(-84.2060089111)
        h.fcurrent()
